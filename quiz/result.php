      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          ...
          <?php else : ?>
            ...
            <div class="card my-2 p-3 text-center">
              <div class="card-body">
                <h5 class="card-title py-2 text-center">Correct answers</h5>
                <?php 
                  // Array of aid values to fetch
                        $aid_values = array(2, 7, 10, 16);
                        $i=1;

                        // Loop through each aid value and fetch data from the database
                        foreach ($aid_values as $aid) {
                            // Fetching data from the database for current aid value
                            $sql = "SELECT answer FROM answers WHERE aid = '$aid'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    $answer = $row["answer"];
                                    // Displaying the value using HTML
                                    echo "<p>Answer for question $i: $answer</p>";
                                  }
                                  $i++;
                            } else {
                                echo "No results for AID: $aid";
                            }
                        }
